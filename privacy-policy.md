?id "privacy-policy"
?graph [""]
?pubdate "2022-06-27T00:00"
# Privacy Policy

__TLDR:__ While we use 3rd party software (Google Analytics) to understand site traffic, we do not collect or use any personal data for any other purpose whatsoever. However, because this software sets cookies and collects data beyond the scope of our own needs and interests, this privacy policy intends to  address details far beyond our own purview.
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sound Opinions, 3501 N. Southport #161, Chicago IL 60657.
...
- __Website__ refers to Sound Opinions, accessible from [https://soundopinions.org](https://soundopinions.org)
...
- By email: interact@soundopinions.org